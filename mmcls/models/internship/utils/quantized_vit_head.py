...
from mmcls.models.internship.utils.quantized_ops import ExtendedQuantizedOps, ExtendedQuantizedOpsStub
...
class VisionTransformerClsHeadQ(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(VisionTransformerClsHeadQ, self).__init__(
    ...
    def init_weights(self):
        super(VisionTransformerClsHeadQ, self).init_weights()
    ...
    def simple_test(self, x, softmax=True, post_process=True):
        ...
        if softmax:
            pred = (
                self.softmax.softmax(cls_score, dim=1) if cls_score is not None else None)
        else:
            pred = cls_score
