...
from tools.internship.progress_bar_reporting import VTProgressBar
...
def single_gpu_test(model,
    ...
    prog_bar = VTProgressBar(len(dataset))
    for i, data in enumerate(data_loader):
        ...
        prog_bar.update(num_tasks=batch_size)

    fps = prog_bar.results['fps']
    return sum(fps)/len(fps), results
